...
import com.lucasataide.deliver.entities.OrderStatus;

public class OrderDTO implements Serializable{ //serializable é um padrão para permitir que o objeto seja transformado em uma sequencia de bytes
